...
export const siteConfig: SiteConfig = {
  title: "horoscope's blog", // 站点标题
  subtitle: "追寻你自己的星星！",
  siteURL: "https://blog.horoscope.xtkx.site/", // 请替换为你的站点URL，以斜杠结尾
  siteStartDate: "2026-07-05", // 站点开始运行日期，用于站点统计组件计算运行天数

  lang: SITE_LANG,

  themeColor: {
    hue: 140, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
  ...
  bilibili: {
    vmid: "330746367", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
